...
def studentwin():
    ...
    F7=Entry(F4,width=15,font=style)
    F7.grid(row=0,column=1,pady=2)
    F8=Entry(F4,width=15,font=style)
    ...
    F11=Entry(F4,width=15,font=style)
    F11.grid(row=3,column=1)
    Verify=Button(F4,text="Reset",font=("timesnewroman",10,"bold"),width=25)
    Verify.grid(row=5,column=0,pady=10)
    Submit=Button(F4,text="Login",font=("timesnewroman",10,"bold"),width=25)
