...
def generate_new_captcha():
    ...
    Val8.config(text="Captcha:"+str(captcha1))
def reset():
...
Type=Radiobutton(F1,text="Student",font=style,background=backcolour,activebackground=backcolour3,value="Student",variable=var,command=selected)
Type.grid(row=0,column=0)
Type1=Radiobutton(F1,text="Instructor",font=style,background=backcolour,activebackground=backcolour3,variable=var,value="Instructor",command=selected)
Type1.grid(row=0,column=1)
Type2=Radiobutton(F1,text="Administrator",font=style,background=backcolour,activebackground=backcolour3,variable=var,value="Administrator",command=selected)
...
Val4=Checkbutton(F1,text="Do you want to make\n the changes applicable",background=backcolour,fg="black",font=style2,activebackground=backcolour3)
Val4.grid(row=3,column=0,pady=10)
Val5=Button(F1,text="Add User",background=Buttoncolor,font=style,activebackground=backcolour,width=15)
...
Val7=Button(F1,text="Revoke User",background=Buttoncolor,font=style,activebackground=backcolour,width=15)
Val7.grid(row=5,column=2,padx=15)
Val8=Label(F1,text="",font=style3,bg="white",width=15)
...
generate_new_captcha()
Val9=Button(F1,text="Allow User",background=Buttoncolor,font=style,activebackground=backcolour,width=15)
